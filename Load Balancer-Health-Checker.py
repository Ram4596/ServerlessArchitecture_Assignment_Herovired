...
def lambda_handler(event, context):
    ...
    elb_name = 'arn:aws:elasticloadbalancing:ap-south-1:295397358094:targetgroup/Target-Group-Ramvenu/85e7dac5fa5a9822'
    ...
    if unhealthy_instances:
        ...
        sns_topic_arn = 'arn:aws:sns:ap-south-1:295397358094:RamVenu_SNS'
